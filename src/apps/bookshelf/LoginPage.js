...
export default function LoginPage({ onLogin, loading, authError }) {
  ...
  // Show either the login-attempt error or the post-auth error from useStore
    ...
    <div className="bs-login-bg">
      <div className="bs-login-card">
        ...
        <form className="bs-login-form" onSubmit={submit}>
          ...
          {displayError && (
            <div className="bs-login-err" style={{
              whiteSpace: 'pre-wrap',
