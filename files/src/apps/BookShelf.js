...
export default function BookShelf() {
  ...
  const { user, profile, loading, fbActive,
  ...
  if (!user || !profile) return <LoginPage onLogin={login} loading={loading} />;
  ...
  return (
    <div className="bs">
      ...
      <main className="bs-main">
        ...
        {tab==='pos'       && perms.canDoPOS            && <POS         products={products} onSale={handleSale} profile={profile} settings={settings} creditCustomers={creditCustomers} categories={categories}/>}
        {tab==='inventory' && perms.canManageInventory  && <Inventory   products={products} onAdd={handleAddProd} onUpdate={handleUpdateProd} onDelete={handleDelProd} canEdit={perms.canAdjustPrices} canDelete={perms.canDeleteInventory} settings={settings} categories={categories}/>}
